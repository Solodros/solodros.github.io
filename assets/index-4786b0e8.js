...
`,ConfigureBasePane=styled(Pane$9)`
  ...
  pointer-events: none;
  z-index: 3;
`,SvgIcLightbulbOutline24Px=e=>jsx("svg",{width:11.9,height:17,...e,children:jsx("path",{d:"M3.4 16.15a.853.853 0 00.85.85h3.4a.852.852 0 00.85-.85v-.85H3.4zM5.95 0a5.947 5.947 0 00-3.4 10.829v1.921a.852.852 0 00.85.85h5.1a.852.852 0 00.85-.85v-1.921A5.947 5.947 0 005.95 0zm2.422 9.435l-.722.51V11.9h-3.4V9.945l-.722-.51a4.25 4.25 0 114.845 0z",fill:"currentColor"})}),title$4="灯光",component$4=SvgIcLightbulbOutline24Px,AccentButtonBase=styled.button`
  height: 40px;
  padding: 0 15px;
  line-height: 40px;
  min-width: 100px;
...
`,SliderInput=styled.input.attrs({type:"range"})`
  ...
  width: 100%;
`,AccentRange=e=>{const[t,o]=reactExports.useState(e.defaultValue||0),n=r=>{const s=+r.target.value;o(s),e.onChange&&e.onChange(s)};return jsxs(Container$f,{children:[jsx(SliderInput,{...e,value:t,onChange:n}),jsx(NumberInput,{...e,type:e.type==="number"?"number":void 0,value:t,onChange:n})]})},ColorPickerContainer=styled.div`
  display: flex;
  align-items: center;
...
`,loadingMessages=["正在加载中，不妨来一杯无糖可乐 ☕","稍等一下，键盘正在打扮自己 🎀","加载中，摸摸鱼也不亏 🐟","键帽正在上车，请稍候 🚃","系统正在唤醒键盘灵魂 ✨","启动中，感觉像在组装高达 🤖","等待的时间里，不如想想晚饭吃啥 🍜","正在连接到键盘宇宙 🪐","咕噜咕噜加载中，别催啦 😄","你的键盘马上就绪，准备起飞 🛫","没有广告，纯净加载 🍃","调整键盘姿势中，请稍等 🧘","正在擦亮键帽 ✨","键盘正在启动 💡","键盘精灵正在上岗 🧚‍♂️","正在读取键帽配置 📚","正在整理键盘 🛠️","检查键盘是否喝够咖啡 ☕","你的键盘正在热身 🧘‍♀️","准备好敲出世界 🌍","即将开启键盘魔法 🪄","祝你天天开心 😄","加油布鲁斯 🐶"];function Loading(e){const t=reactExports.useRef(null),o=reactExports.useRef(new Set),[n,r]=reactExports.useState(loadingMessages[0]);return reactExports.useEffect(()=>{if(!e.isSearching){o.current.size===loadingMessages.length&&o.current.clear();let s;do s=Math.floor(Math.random()*loadingMessages.length);while(s===t.current||o.current.has(s));t.current=s,o.current.add(s),r(loadingMessages[s])}},[e.isSearching]),jsx(LoadingText,{"data-tid":"loading-message",children:e.isSearching?"正在搜索支持的键盘 🔍":n})}const Button=styled.div`
  display: flex;
  transition: transform 0.2s ease-out;
  user-select: none;
  color: #717070;
...
`,title$3="按键",component$3=e=>jsx(FontAwesomeIcon,{icon:faBook}),Message$1=styled.span`
  font-size: 18px;
  margin: 8px;
  text-align: center;
...
`,MacroControlGroupDivider=styled.div`
  ...
  height: 80%;
  margin: 0 10px;
`,MacroEditControls=({isFullscreen:e,isRecording:t,recordingToggleChange:o,hasUnsavedChanges:n,undoChanges:r,saveChanges:s,recordDelays:i,toggleRecordDelays:a,optimizeRecording:c,toggleOptimizeRecording:l,isEmpty:d,deleteMacro:u,toggleFullscreen:_,isDelaySupported:C})=>jsxs(MacroEditControlsContainer,{children:[n?jsx(Fragment,{children:t?null:jsxs(Fragment,{children:[jsxs(MacroControlGroupContainer,{children:[jsxs(IconButtonContainer,{disabled:!n||t,onClick:r,children:[jsx(FontAwesomeIcon,{size:"sm",color:"var(--color_label)",icon:faUndo}),jsx(IconButtonTooltip,{children:"取消修改"})]}),jsxs(IconButtonContainer,{disabled:!n||t,onClick:()=>s(),children:[jsx(FontAwesomeIcon,{size:"sm",color:"var(--color_label)",icon:faSave}),jsx(IconButtonTooltip,{children:"保存修改"})]})]}),jsx(MacroControlGroupDivider,{})]})}):d?jsx(Fragment,{}):jsxs(Fragment,{children:[jsx(MacroControlGroupContainer,{children:jsxs(IconButtonContainer,{disabled:n||t,onClick:u,children:[jsx(FontAwesomeIcon,{size:"sm",color:"var(--color_label)",icon:faTrash}),jsx(IconButtonTooltip,{children:"删除宏"})]})}),jsx(MacroControlGroupDivider,{})]}),jsxs(MacroControlGroupContainer,{children:[jsxs(IconButtonContainer,{onClick:()=>{o(!t)},disabled:!e,children:[jsx(FontAwesomeIcon,{size:"sm",color:"var(--color_label)",icon:t?faSquare:faCircle}),jsx(IconButtonTooltip,{children:e?t?"停止录制":"录制按键":"只能在全屏时录制"})]}),jsxs(IconButtonContainer,{onClick:_,children:[jsx(FontAwesomeIcon,{size:"sm",color:"var(--color_label)",icon:e?faCompress:faExpand}),jsx(IconButtonTooltip,{children:e?"退出全屏":"进入全屏"})]})]}),t?null:jsxs(Fragment,{children:[jsx(MacroControlGroupDivider,{}),jsxs(MacroControlGroupContainer,{children:[jsxs(IconToggleContainer,{$selected:c,onClick:l,children:[jsx(FontAwesomeIcon,{size:"sm",icon:faMagicWandSparkles}),jsx(IconButtonTooltip,{children:c?"取消智能优化":"使用智能优化"})]}),jsxs(IconToggleContainer,{disabled:!C,$selected:i,onClick:a,children:[jsx(FontAwesomeIcon,{size:"sm",icon:faStopwatch,className:"fa-stack-1x"}),jsx(IconButtonTooltip,{children:C?i?"跳过录制延迟":"录制延时":"升级固件以使用延迟"})]})]})]})]}),DeletableContainer=styled.div`
  display: inline-flex;
  vertical-align: middle;
  position: relative;
  svg {
...
`,componentJoin=(e,t)=>e.reduce((o,n,r)=>(r&&o.push({...t,key:r.toString()}),o.push(n),o),[]),KeycodeMap=getKeycodes().flatMap(e=>e.keycodes).reduce((e,t)=>({...e,[t.code]:t}),{}),optimizeKeycodeSequence=e=>pipeline(e,convertCharacterTaps,trimLastWait,mergeConsecutiveWaits,foldKeydownKeyupKeys,convertToCharacterStreams),cleanKeycodeSequence=e=>pipeline(e,mergeConsecutiveWaits),MacroRecorder=({selectedMacro:e,setUnsavedMacro:t,saveMacro:o,undoMacro:n,isDelaySupported:r})=>{const[s,i]=reactExports.useState(!0),[a,c]=reactExports.useState(!1),[l,d]=reactExports.useState(!1),[u,_]=reactExports.useState(!!document.fullscreenElement),{smartOptimizeEnabled:C,recordDelaysEnabled:h}=useAppSelector(getMacroEditorSettings),p=useDispatch(),[K,y]=useKeycodeRecorder(a,h),g=reactExports.useRef(null),m=reactExports.useCallback(async f=>{c(f),f?(await navigator.keyboard.lock(),y([]),i(!1),d(!0)):(navigator.keyboard.unlock(),C&&y(optimizeKeycodeSequence(K)),d(!1))},[K,c]),S=reactExports.useCallback(()=>{o(""),i(!0),d(!1)},[y,o]),b=reactExports.useCallback(()=>{n(),y([]),i(!0),d(!1)},[n]);reactExports.useEffect(()=>{i(!0),d(!1),y([])},[e]);const T=()=>[...s?e??[]:K],M=reactExports.useMemo(()=>{let f,E=T();return s||!l||!C?f=E:f=optimizeKeycodeSequence(E),f},[K,s,C,l,e]);reactExports.useEffect(()=>{M&&t(sequenceToExpression(M))},[M]);const A=reactExports.useCallback(()=>{s&&i(!1)},[s]),w=reactExports.useCallback(f=>{const E=T();E.splice(f,1),y(cleanKeycodeSequence(E)),A()},[M,e,K,s]),O=reactExports.useCallback((f,E)=>{const D=T();D.splice(f,1,[RawKeycodeSequenceAction.Delay,E]),y(cleanKeycodeSequence(D)),A()},[M,e,K,s]),I=reactExports.useMemo(()=>componentJoin(M.map(([f,E],D)=>{const L=getSequenceItemComponent(f);return jsx(Deletable,{index:D,deleteItem:w,disabled:a,children:RawKeycodeSequenceAction.Delay!==f?jsx(L,{children:f===RawKeycodeSequenceAction.CharacterStream?componentJoin(String(E).split(" ").map((R,N)=>jsx("span",{children:R},N)),jsx("span",{style:{fontFamily:"fantasy, cursive, monospace"},children:"␣"})):Array.isArray(E)?E.map(R=>getSequenceLabel(KeycodeMap[R])??R).join(" + "):getSequenceLabel(KeycodeMap[E])}):jsx(WaitInput,{index:D,value:Number(E),updateValue:O})},`${D}-${f}`)}),jsx(SequenceLabelSeparator,{})),[M]);reactExports.useEffect(()=>{const f=()=>{_(!!document.fullscreenElement)};return document.documentElement.addEventListener("fullscreenchange",f),()=>{m(!1),document.documentElement.removeEventListener("fullscreenchange",f)}},[_]);const v=reactExports.useCallback(()=>{document.fullscreenElement?document.exitFullscreen&&(m(!1),document.exitFullscreen()):document.documentElement.requestFullscreen()},[m]);return jsxs(Fragment,{children:[jsx(MacroSequenceContainer,{ref:g,$isModified:!s,children:I.length?I:jsx(NoMacroRecorded,{children:"尚未录制宏..."})}),jsx("div",{style:{border:"none",maxWidth:960,width:"100%",display:"flex",justifyContent:"center",transform:"translate(-0px, -21px)"},children:jsx(MacroEditControls,{isFullscreen:u,isEmpty:!e||!e.length,optimizeRecording:C,recordDelays:h,isRecording:a,addText:()=>{},deleteMacro:S,toggleOptimizeRecording:()=>{p(setMacroEditorSettings({smartOptimizeEnabled:!C}))},toggleRecordDelays:()=>{p(setMacroEditorSettings({recordDelaysEnabled:!h}))},toggleFullscreen:v,undoChanges:b,saveChanges:()=>o(),hasUnsavedChanges:!s,recordingToggleChange:m,isDelaySupported:r})})]})},TextArea=styled.textarea`
  box-sizing: border-box;
  background: var(--bg_control);
  padding: 5px 10px;
...
`,AutoHeightRow=styled(ControlRow)`
  height: auto;
`,ScriptMode=({macro:e,protocol:t,setUnsavedMacro:o,saveMacros:n,macroIndex:r,isDelaySupported:s})=>{const i=e.trimEnd(),[a,c]=React.useState(i),[l,d]=React.useState(void 0);reactExports.useEffect(()=>{o(a)},[a]);const u=()=>{const h=getMacroValidator(t)(a);h.isValid?(n(a),d(void 0)):d(h.errorMessage)};return jsxs(Fragment,{children:[jsx(AutoHeightRow,{children:jsx(ReactTextareaAutocomplete,{value:a,onChange:C=>c(C.target.value),loadingComponent:AutocompleteLoading,style:{fontSize:"16px",lineHeight:"18px",width:"100%",height:"140px",fontFamily:"monospace",resize:"none",borderColor:l!==void 0?"var(--color_error)":"var(--border_color_icon)"},containerStyle:{border:"none",lineHeight:"20px"},itemStyle:{borderColor:"var(--border_color_cell)",backgroundColor:"var(--bg_menu)"},dropdownStyle:{zIndex:999,backgroundColor:"var(--bg_menu)"},listStyle:{position:"fixed",backgroundColor:"var(--bg_menu)",maxHeight:"210px",overflow:"auto",border:"1px solid var(--border_color_cell)"},minChar:0,textAreaComponent:TextArea,movePopupAsYouType:!0,placeholder:`在这里输入宏 M${r}...`,trigger:{"?":{dataProvider:findKeycodes,component:AutocompleteItem,output:C=>({text:C.code,caretPosition:"end"})},"{":{dataProvider:findKeycodes,component:AutocompleteItem,output:C=>({text:`{${C.code},`,caretPosition:"end"})},",":{dataProvider:findKeycodes,component:AutocompleteItem,output:C=>({text:`,${C.code},`,caretPosition:"end"})}}})}),jsxs(AutoHeightRow,{children:[jsxs(DescriptionLabel,{children:[jsx(ToastErrorMessage,{children:l}),jsxs(Message,{children:["直接输入文本，或者键码"," ",jsx(Link,{href:"https://docs.qmk.fm/#/keycodes_basic",target:"_blank",children:"基础键码"})," ","在 ","{}","内"]}),jsxs(Message,{children:["单击: ","{KC_XXX}"]}),jsxs(Message,{children:["组合键: ","{KC_XXX, KC_YYY, KC_ZZZ}"]}),jsxs(Message,{children:["按键按下: ","{+KC_XXX}"]}),jsxs(Message,{children:["按键弹起: ","{-KC_XXX}"]}),s?jsxs(Message,{children:["延时 (ms): ","{NNNN}"," "]}):"升级固件才可以使用延迟",jsx(Message,{children:"输入 ? 搜索键码"})]}),jsx(Detail,{children:jsx(AccentButton,{disabled:e===a,onClick:u,children:"保存"})})]})]})},ProgressBarContainer=styled.div`
  position: relative;
  margin-top: 10px;
  &:hover {
    & .tooltip {
