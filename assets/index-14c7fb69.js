...
`,loadingMessages=["正在加载中，不妨来一杯无糖可乐 ☕","稍等一下，键盘正在打扮自己 🎀","加载中，摸摸鱼也不亏 🐟","键帽正在上车，请稍候 🚃","系统正在唤醒键盘灵魂 ✨","启动中，感觉像在组装高达 🤖","等待的时间里，不如想想晚饭吃啥 🍜","正在连接到键盘宇宙 🪐","咕噜咕噜加载中，别催啦 😄","你的键盘马上就绪，准备起飞 🛫","没有广告，纯净加载 🍃","调整键盘姿势中，请稍等 🧘","正在对齐键位宇宙的频率 📡","加载速度受今日运势影响 🧧","祝你天天开心 😄"];function Loading(e){const t=reactExports.useRef(null),[o,n]=reactExports.useState(loadingMessages[0]);return reactExports.useEffect(()=>{if(!e.isSearching){let r;do r=Math.floor(Math.random()*loadingMessages.length);while(r===t.current);t.current=r,n(loadingMessages[r])}},[e.isSearching]),jsx(LoadingText,{"data-tid":"loading-message",children:e.isSearching?"正在搜索支持的键盘":o})}const Button=styled.div`
  display: flex;
  transition: transform 0.2s ease-out;
  user-select: none;
  color: #717070;
